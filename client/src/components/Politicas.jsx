            ...
            <section className="bg-blueGray-50">
                <div className="w-full lg:w-8/12 px-4 mx-auto pt-6">
                    <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-200 border-0">
                        <h1 className="text-center"><b>El Ocañerito</b></h1>
                        <h2><b>Políticas de privacidad</b></h2>
                        <p>
                            El sitio web El Ocañerito es propiedad de El Ocañerito, que es un controlador de datos de tus datos personales.
                        </p>
                        <br />
                        <p>
                            Hemos adoptado esta Política de privacidad, que determina cómo procesamos la información recopilada por El Ocañerito, que también proporciona las razones por las que debemos recopilar ciertos datos personales sobre ti. Por lo tanto, debes leer esta Política de privacidad antes de usar el sitio web de El Ocañerito.
                        </p>
                        <br />
                        <p>
                        ...
                        <p>
                            ...
                            Si deseas comunicarte con nosotros para comprender más sobre esta Política o deseas comunicarte con nosotros en relación con cualquier asunto sobre los derechos individuales y tu información personal, puedes enviarnos un correo electrónico a El Ocañeritoe07@gmail.com.
                        </p>
                    </div>
                </div>
            </section>
